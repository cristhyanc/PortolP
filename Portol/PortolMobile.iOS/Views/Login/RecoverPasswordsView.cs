...
namespace PortolMobile.iOS.Views.Login
{
    ...
    public partial class RecoverPasswordsView : MvxViewController<RecoverPasswordViewModel>
    {
        public RecoverPasswordsView() : base(nameof(RecoverPasswordsView), null)
        {
        }
        ...
        public override void ViewDidLoad()
        {
            ...
            var set = this.CreateBindingSet<RecoverPasswordsView, RecoverPasswordViewModel>();
